...
volume_driver=cinder.volume.drivers.violin.v7000_fcp.V7000ISCSIDriver
...
class V7000ISCSIDriver(driver.ISCSIDriver):
    ...
    def check_for_setup_error(self):
        ...
        if len(self.gateway_iscsi_ip_addresses) == 0:
            ...
            raise v7000_common.InvalidBackendConfig(reason=msg)
    ...
    def initialize_connection(self, volume, connector):
        ...
        if not resp['success'] and 'Error: 0x900100cd' not in resp['msg']:
            ...
            raise v7000_common.ViolinBackendErr(message=msg)

        LOG.debug("Create iscsi tgt- name %(iqn)s: client %(client)s: "
                  "ip %(ip)s " %
                  {'iqn': iqn, 'client': connector['host'],
    ...
    def update_migrated_volume(self, ctxt, original_volume, current_volume,
                               original_volume_status=None):
        self.common._update_migrated_volume(original_volume,
			                    current_volume,
    ...
    def _export_lun(self, volume, target, connector):
        ...
        try:
            ...
            raise v7000_common.ViolinInvalidBackendConfig(
